...
const Angry = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <style>
      {
        ".st0{fill:url(#SVGID_1_)}.st1{fill:#262c38}.st2{fill:none;stroke:#262c38;stroke-width:60;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10}"
      }
    </style>
    <linearGradient
      id="SVGID_1_"
    ...
    <path
      className="st2"
      d="M205.9 805.1s120.5 93.7 423.4 93.7M1291.9 805.1s-120.5 93.7-423.4 93.7"
    />
    <path
      className="st1"
